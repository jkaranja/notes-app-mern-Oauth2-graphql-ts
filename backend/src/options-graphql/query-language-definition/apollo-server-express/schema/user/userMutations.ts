 ...
 * REGISTER
 ------------------------------------------------------------*/
  ...
  async registerUser(_: any, args: any, { req, res }: any) {
    ...
    if (!created) {
      return { message: "Check details and try again" };
    }
 ...
 * RESEND EMAIL
 ------------------------------------------------------------*/
  ...
  async resendVerifyEmail(_: any, args: any, { req }: any) {
  ...
  async updateUser(_: any, args: any, { req, res }: any) {
    const { username, email, phoneNumber, password, newPassword } = args;
  ...
  async deleteUser(_: any, args: any, { req, res }: any) {
    const { id } = req.params;
